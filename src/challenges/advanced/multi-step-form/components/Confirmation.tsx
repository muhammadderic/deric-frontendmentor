export function Confirmation() {
  return (
    <div className="py-8 px-2 lg:py-12 lg:px-8 text-center">
      ...
      <p className="my-4 lg:my-6 text-2xl lg:text-3xl font-bold text-[#02295a]">
        Thank you!
      </p>

      <p className="leading-6 lg:leading-7 text-[#9699ab] max-w-md mx-auto">
